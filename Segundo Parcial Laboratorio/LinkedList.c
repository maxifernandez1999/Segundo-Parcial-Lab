...
LinkedList* ll_filter_parametro(LinkedList* this, int (*fn)(void* element), char* cadena)
{
    int i;
    int len;
    int ret;
    ...
    if(ListAux != NULL && this != NULL)
    {
        ...
        for(i = 0; i < len; i++)
        {
            ...
            ret = fn(pElement);
            if(ret == 1 && (strcasecmp(destino,cadena)==0))
            {
                ll_add(ListAux,pElement);
            }
        }
